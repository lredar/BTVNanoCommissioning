    ...
    "2023_Summer23": {
        ...
        "PNet": {
            ...
            "2D": {
                ...
                "C0": [0.144, 0.292, 0.000, 1.000],
                "C1": [0.292, 0.646, 0.000, 1.000],
                "C2": [0.646, 1.000, 0.078, 0.240],
                "C3": [0.646, 1.000, 0.036, 0.078],
                "C4": [0.646, 1.000, 0.000, 0.036],
                "B0": [0.646, 1.000, 0.240, 0.752],
                "B1": [0.646, 1.000, 0.752, 0.915],
                "B2": [0.646, 1.000, 0.915, 0.972],
                "B3": [0.646, 1.000, 0.972, 0.992],
                "B4": [0.646, 1.000, 0.992, 1.000],
                "mapping": {
                    "L0": 0,
                    "C0": 1,
                    "C1": 2,
    ...
    "2023_Summer23BPix": {
        ...
        "PNet": {
            ...
            "2D": {
                ...
                "C0": [0.144, 0.288, 0.000, 1.000],
                "C1": [0.288, 0.640, 0.000, 1.000],
                "C2": [0.640, 1.000, 0.082, 0.243],
                "C3": [0.640, 1.000, 0.036, 0.082],
                "C4": [0.640, 1.000, 0.000, 0.036],
                "B0": [0.640, 1.000, 0.243, 0.742],
                "B1": [0.640, 1.000, 0.742, 0.909],
                "B2": [0.640, 1.000, 0.909, 0.969],
                "B3": [0.640, 1.000, 0.969, 0.992],
                "B4": [0.640, 1.000, 0.992, 1.000],
                "mapping": {
                    "L0": 0,
                    "C0": 1,
                    "C1": 2,
